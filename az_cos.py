...
class az_cos:
    ...
    def db_con(self):
        utz.enter2()
        self.client = CosmosClient("https://pgmabv88.documents.azure.com:443/",
                                   {'masterKey': "F1YNTaDlzsNDcZthR1YHFyF7ol2aW67C7lLfc7s9b4pnXCiBodLyB5AubiolB5lNH1U7P1lz5hGQSgc2kAygGQ=="})
